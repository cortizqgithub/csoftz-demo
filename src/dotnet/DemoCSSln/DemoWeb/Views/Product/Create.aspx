...
<asp:Content ID="TitleContent" ContentPlaceHolderID="TitleContent" runat="server">Create</asp:Content>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Create</h2>
    <div id="msg-box" style="display: none"></div>
    <% using (Html.BeginForm("Create", "Product", null, FormMethod.Post, new { id = "productfrm" })) {%>
    ...
    <p>(*) Required Fields</p>
    <p><input id="cmd" type="submit" value="Create" /></p>
    <% } %>
    <div>
